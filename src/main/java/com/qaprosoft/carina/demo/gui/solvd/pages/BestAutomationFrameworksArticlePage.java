...
public class BestAutomationFrameworksArticlePage extends AbstractPage {
    private static final Logger LOGGER = LoggerFactory.getLogger(BestAutomationFrameworksArticlePage.class);
    ...
    public boolean isPageOpened() {
        return driver.getCurrentUrl().equals("https://blog.solvd.com/10-best-open-source-test-automation-frameworks-for-every-purpose");
    }
}
